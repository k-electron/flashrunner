...
```bash
.specify/extensions/lifecycle/scripts/lifecycle-engine.py overview "$@"
```
...
1. Run `.specify/extensions/lifecycle/scripts/lifecycle-engine.py overview` to compile the dashboard.
